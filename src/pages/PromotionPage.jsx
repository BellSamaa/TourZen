...
// ✅ Xóa import component bên ngoài và định nghĩa component tạm thời bên dưới
...
// ✅ BƯỚC SỬA LỖI: Định nghĩa component tạm thời để giải quyết lỗi import
// Bạn có thể thay thế nội dung các component này bằng code gốc của bạn.
const PromotionCard = ({ promo, onClaim }) => (
  <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
    <div className="relative">
      <img src={promo.image} alt={promo.title} className="w-full h-56 object-cover" />
      <div className="absolute top-4 left-4 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full">{promo.tag}</div>
    </div>
    <div className="p-6">
      <h3 className="text-xl font-bold text-neutral-800 dark:text-white mb-2">{promo.title}</h3>
      ...
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => onClaim(promo)} className="bg-blue-600 text-white px-5 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
          Săn Voucher
        </button>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <p className="mb-2 text-neutral-700 dark:text-neutral-300">Mã voucher của bạn cho ưu đãi <span className="font-semibold">{promo.title}</span> là:</p>
    ...
    <div className="bg-gray-50 dark:bg-neutral-900 min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 py-16">
        ...
        >
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">Các chương trình khuyến mãi hấp dẫn nhất được cập nhật mỗi ngày đang chờ bạn!</p>
        </motion.div>
