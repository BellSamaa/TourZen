...
// 1. Import thêm icon "Edit" từ lucide-react
import { ShoppingCart, MapPin, Star, PlaneTakeoff, Edit } from "lucide-react"; 
import { motion, AnimatePresence } from "framer-motion";
import { useCart } from "../context/CartContext";
// 2. Import "useAuth" để biết có phải admin không
...
    >
      {/* 5. THÊM NÚT EDIT CHO ADMIN */}
      {/* Nút này chỉ hiện khi 'isAdmin' là true */}
      {isAdmin && (
        <button
          onClick={() => onEdit(tour)}
          // Đặt ở top-left (z-20) để không đè lên badge 'duration' (top-right)
